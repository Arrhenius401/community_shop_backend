...
import com.community_shop.backend.service.exception.BaseException;
...
public interface UserService {
    ...
    //若姓名、邮箱和电话非法，则抛出对应异常
    //针对add，update
    void checkFactor(User user) throws BaseException;

    //根据userId检查用户是否存在
    //针对update
    void checkUserExists(int userId) throws BaseException;
}
