package xyz.graygoo401.community.convert;
...
public interface PostConvert {
    ...
    /**
     * UserDTO 实体 -> PostDetailDTO.PublisherDTO（帖子详情中的发布者信息）
     * 映射说明：仅返回部分字段，忽略部分字段
     */
    PostDetailDTO.PublisherDTO userDTOToPostDetailPublisherDTO(UserDTO user);
}
