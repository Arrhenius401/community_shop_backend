...
CREATE TABLE `order` (
    ...
    status VARCHAR(20) NOT NULL COMMENT '订单状态（枚举OrderStatusEnum的code：PENDING_PAYMENT/PAID/SHIPPED/RECEIVED/CANCELLED）',
    pay_type VARCHAR(20) COMMENT '支付方式（枚举PayTypeEnum的code：WECHAT/ALIPAY）',
