package xyz.graygoo401.trade.convert;

import org.mapstruct.Mapper;
import org.mapstruct.Mapping;
import org.mapstruct.Mappings;
import org.mapstruct.factory.Mappers;
import xyz.graygoo401.api.trade.dto.order.OrderCreateDTO;
import xyz.graygoo401.api.trade.dto.order.OrderDetailDTO;
import xyz.graygoo401.api.trade.dto.order.OrderListItemDTO;
...
public interface OrderConvert {
    ...
    /**
     * UserDTO 实体 -> OrderDetailDTO.BuyerSimpleDTO（订单详情中的买家信息）
     * 映射说明：仅返回部分字段，忽略部分字段
     */
    OrderDetailDTO.BuyerSimpleDTO userDTOToBuyerSimpleDTO(UserDTO user);

    /**
     * UserDTO 实体 -> OrderDetailDTO.SellerSimpleDTO（订单详情中的卖家信息）
     * 映射说明：仅返回部分字段，忽略部分字段
     */
    OrderDetailDTO.SellerSimpleDTO userDTOToSellerSimpleDTO(UserDTO user);
