package xyz.graygoo401.user.service;
...
import xyz.graygoo401.user.service.impl.UserServiceImpl;
...
public class UserServiceTest {
    ...
    void testRegisterByEmail_Success() {
        ...
        when(infraClient.checkEmailVerifyCode(any(VerifyEmailDTO.class))).thenReturn(ResultVO.success(true));
    ...
    void testRegisterByPhone_Success() {
        ...
        when(infraClient.checkPhoneVerifyCode(any(VerifyPhoneDTO.class))).thenReturn(ResultVO.success(true));
    ...
    void testLogin_Success() {
        ...
        when(userConvert.userToLoginResultUserSimpleDTO(any(User.class))).thenAnswer(invocation -> {
            ...
            user.setCreditScore(testUser.getCreditScore());
