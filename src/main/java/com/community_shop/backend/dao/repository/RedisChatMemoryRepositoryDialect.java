package com.community_shop.backend.dao.repository;
...
import static com.community_shop.backend.convert.SpringAiMessageConvert.chatMessageToMessage;
import static com.community_shop.backend.convert.SpringAiMessageConvert.messageToChatMessage;

/**
 * 使用 Redis 实现的 Spring AI 会话记忆仓库方言
 */
@Slf4j
@Component
